# Audit Skill: Load ad scripts statically

**Category**: Best practices  
**Lighthouse audit ID**: `script-injected-tags`  
...
This audit checks whether or not ad scripts are being injected into the page.
