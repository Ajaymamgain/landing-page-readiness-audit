# Audit Skill: Load ad tag asynchronously

**Category**: Performance  
**Lighthouse audit ID**: `async-ad-tags`  
...
while scripts are loading and decreases the time necessary to load all critical
components.
